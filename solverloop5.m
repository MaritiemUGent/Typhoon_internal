function [results]=solverloop5(results,quest,JID,lattice,state,geo,ref);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
case 1  
  [results,lattice]=solver9(results,state,geo,lattice,ref);
...
%% removed in favor of stability1.m  
  %{
case 2
   lock(4)=0;
   ...
   for alpha=a1:b1:c1
        ...
        [results]=coeff_create3(results,lattice,state,ref,geo);
      	...
      	results.alpha_sweep(j)=state.theta;	
...
case 10
    ...
    Mach=state.STW/a;                           %Computing local TAS 
...
disp('****************** ')
  ...
  tdisp(' ')
   ...
   case 14 
    ...
    disp(' ')
    disp(strcat('Stall angle of attack [deg]: ',num2str(state.theta*180/pi)));
    disp(' ')   
...
case 17
 ...
 % tdisp(' ')
    ...
    case 18
        ...
        tdisp(strcat('**********',' Alpha = ',num2str(state.theta*57.2958),'  *****************'))
