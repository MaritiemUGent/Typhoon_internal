...
for m=2:2
	...
	for j=8:8
		...
		cd(settings.odir)
		fileID = fopen('Depth_NoWave.txt','a');
		
		
		fileID = fopen('Depth_Faltinsen.txt','a');
		fprintf(fileID, '%i \t %i \t %i \t %i \t %i \t %i \t %i \t %i \t %i \t %i \t %i \n', Fc,Fh,hc,...
			results.L,results.D,Cl,Cd,results.sumgamma,results.sumw2,...
			results.meangamma,results.meanw2);
		fclose(fileID);
		cd(settings.hdir)
...
% 		close
		...
		rotate3d on
		colormap(hot);
		fill3(lattice.XYZ(:,:,1)',lattice.XYZ(:,:,2)',lattice.XYZ(:,:,3)',results.Windy2(1,1:s1));
		title(strcat('Fc: ',tit1, 'hc: ', tit2,' - WINDY PLOT X'))
		colorbar('vert')
		axis equal
		...
		rotate3d on
		colormap(hot);
		fill3(lattice.XYZ(:,:,1)',lattice.XYZ(:,:,2)',lattice.XYZ(:,:,3)',results.Windy2(2,1:s1));
		title(strcat('Fc: ',tit1, 'hc: ', tit2,' - WINDY PLOT Y'))
		colorbar('vert')
		axis equal
		...
		rotate3d on
		colormap(hot);
		fill3(lattice.XYZ(:,:,1)',lattice.XYZ(:,:,2)',lattice.XYZ(:,:,3)',results.Windy2(3,1:s1));
		title(strcat('Fc: ',tit1, 'hc: ', tit2,' - WINDY PLOT Z'))
		colorbar('vert')
		axis equal
		...
		rotate3d on
		colormap(hot);
		fill3(lattice.XYZ(:,:,1)',lattice.XYZ(:,:,2)',lattice.XYZ(:,:,3)',results.induc2(1,1:s1));
		title('inducy distribution X')
		colorbar('vert')
		axis equal
		...
		rotate3d on
		colormap(hot);
		fill3(lattice.XYZ(:,:,1)',lattice.XYZ(:,:,2)',lattice.XYZ(:,:,3)',results.induc2(2,1:s1));
		title('inducy distribution Y')
		colorbar('vert')
		axis equal
		...
		rotate3d on
		colormap(hot);
		fill3(lattice.XYZ(:,:,1)',lattice.XYZ(:,:,2)',lattice.XYZ(:,:,3)',results.induc2(3,1:s1));
		title('inducy distribution Z')
		colorbar('vert')
		axis equal
