...
switch input
   ...
   case 'startup'
       ...
       output.acdir=strcat(pwd,'/hydrofoil');             %aircraft directory 
       output.afdir=strcat(pwd,'/hydrofoil/airfoil');     %airfoil directory 
   ...
   case 'near'
      output=1e-6; %Vortex core radius, change if soulutions are in bad condition 
